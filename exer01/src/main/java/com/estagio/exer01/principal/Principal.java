...
// • Liste todas as vendas feitas no mês atual
...
public class Principal {
    ...
    private void cadastrarVenda() {
        ...
        String dataVenda = leitura.nextLine();
    ...
    private void listarVendas() {
        ...
        for (Venda venda : vendas) {
            System.out.println("Data: " + venda.getDataVenda() + ", Cliente: " + venda.getNomeCliente() + ", Valor: "
                    + venda.getValorVenda());
        }
    }
    ...
    private void calcularTotalVendido() {
        ...
        System.out.println("Total vendido no mês: " + total);
    }
